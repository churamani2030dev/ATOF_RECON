...
public class ZAndPhiForBarsZPositionAndTimePlotterWithDBSCAN{
    ...
    public static void main(String[] args) {
        ...
        extractAdcBankData(reader);
        reader.close();
    }

    private static void extractAdcBankData(HipoReader reader) {
        ...
        while (reader.hasNext()) {
            ...
            for (int hitIndex = 0; hitIndex < numHits; hitIndex++) {
                ...
                // Print hit information as extracted from the ATOF::adc bank
                System.out.printf("Hit -> Sector: %d, Layer: %d, Component: %d, Order: %d, ADC: %d, Time: %.2f, Pedestal: %d\n",
